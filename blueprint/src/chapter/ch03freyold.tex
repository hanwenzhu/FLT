...
\inputleannode{WeierstrassCurve.n_torsion_card}


This theorem actually tells us the structure of the $n$-torsion, because of the following
purely group-theoretic result:
\inputleannode{group_theory_lemma}


\inputleannode{Elliptic_curve_n_torsion_2d}
...
\inputleannode{Frey_curve_j}


\inputleannode{FreyCurve.j_valuation_of_bad_prime}
